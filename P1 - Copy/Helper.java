...
public class Helper
{
    ...
    {
    	Iterator<User> nicknameItr = users.iterator();
    	User temp;
    	while (nicknameItr.hasNext())
    	{
    		temp = nicknameItr.next();
    ...
    {
    	Iterator<BroadcastList> broadcastItr = lists.iterator();
    	while (broadcastItr.hasNext())
    	{
    		BroadcastList temp = broadcastItr.next();
    		if (temp.getNickname().equals(nickname))
    		{
    			return temp;
    		}
    ...
    {
    	List<User> tempUserList = Config.getInstance().getAllUsers();
    	Iterator<User> userItr = tempUserList.iterator();
